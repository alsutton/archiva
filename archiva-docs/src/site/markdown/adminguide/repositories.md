...
| **Cron Expression** | The [cron schedule](http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html) when repository scanning will be executed. |
...
![Managed Repositories](../images/managed-repositories.png)
...
![Remote Repositories](../images/remote-repositories.png)
...
by clicking the 'Action'->'Directories Scanning' button in the repositories page.
...
the [Consumers](./consumers.html) page.
...
To activate repository purge you have to enable the "repository-purge" consumer in the "Repository Scanning" page.
