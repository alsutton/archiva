...
![Merge Button](../images/repository-merge.png)

You will be able to select which target repository to use for merging

![repository-merge-select-target](../images/repository-merge-select-target.png)
...
![Merge Actions](../images/conflicting-artifacts.png)
