...
Installing the standalone distribution of Archiva is quite simple - for an example, see the [Quick Start](../quick-start.html) guide.
...
[MRM-1467](http://jira.codehaus.org/browse/MRM-1467) for more details.
...
By default, Archiva uses embedded [Apache Derby](http://db.apache.org/derby)
...
[Archiva with MySQL](http://cwiki.apache.org/confluence/display/ARCHIVA/Archiva+with+MySQL)
for more details.
...
[Archiva User DB on Derby Network Server](http://cwiki.apache.org/confluence/display/ARCHIVA/Archiva+User+DB+on+Derby+Network+Server)
...
- [Puppet module for Apache Archiva](https://forge.puppetlabs.com/maestrodev/archiva)
