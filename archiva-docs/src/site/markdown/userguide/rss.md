...
2. Via the feed icon in the Repositories page. Right click on the feed icon of the repository
configuration and copy the link. Then add this link to your feed reader.

![rss-repositories](../images/rss-repositories.png)
...
![rss-browse](../images/rss-browse.png)
