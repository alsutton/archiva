...
To get your local Maven 2 installation to use an Archiva proxy you need to add the repositories you require to your 'settings.xml'. This file is usually found in ${user.dir}/.m2/settings.xml (see the [Settings Reference](http://maven.apache.org/settings.html)).
...
## [Guide to Mirror Settings](http://maven.apache.org/guides/mini/guide-mirror-settings.html) for more information.>
