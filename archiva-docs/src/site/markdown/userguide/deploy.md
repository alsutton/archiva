...
For more information, consult the [documentation for the <<<deploy:deploy-file>>> goal](http://maven.apache.org/plugins/maven-deploy-plugin/deploy-file-mojo.html)
...
![Upload Artifact](../images/upload-artifact.jpg)
